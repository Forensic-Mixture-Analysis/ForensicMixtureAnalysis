...
for (ref.pop in pops.for.sims) {
    ...
    results <- LR_calculator_cross_worse(pop_fp, ref_fp, num_contrib, num_sims, is.a.truecontrib, seed)
...
## Create filepath both for the worst case output in addition to the rds file that will record the time taken to run all these files. 
if (is.a.truecontrib==1){
